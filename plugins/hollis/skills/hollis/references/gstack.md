...
The first demonstration is a useful Apple contribution during a plan conversation. Hollis also works without gstack.

When asked to consult Apple during gstack's review, select the relevant plan and unresolved question. Call Hollis from the existing conversation with explicit `cloud` or `cloud-pro`; present its answer inline and continue the user's task. Do not run gstack's entire review again, overwrite its skills, invent a native Hollis hook, or start another host agent just to make the Apple call.
