...
- A runtime upgrade retains its previous version; `setup.sh rollback` deliberately switches back while retaining configuration, conversations and bridges. A newer installed runtime is not automatically downgraded to this plugin's pin.
